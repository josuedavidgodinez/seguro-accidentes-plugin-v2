			...
			<div class="container-mini-tarif-viajes">
				...
				<form id="form-contratacion-aig" action="/firma-seguro-accidentes" method="POST" class="form-validado multistep-asg" novalidate>
					...
					<div id="step-form-anim-4">
						<h2 class="title-viajes">¿Has padecido o padeces algún tipo de enfermedad cardiaca?</h2>
					...
					<div id="step-form-anim-5">
						<h2 class="title-viajes">Facilítanos información detallada acerca de tu enfermedad cardiaca</h2>
					...
					<div id="step-form-anim-6">
						<h2 class="title-viajes">¿Tienes algún tipo de enfermedad grave o minusvalía?</h2>
					...
					<div id="step-form-anim-7">
						<h2 class="title-viajes">Facilítanos información detallada acerca de tus problemas de salud y/o minusvalía</h2>
